...
También completar en la línea 57 con la ruta (path absoluto) donde en encuentre la carpeta "DataSets Limpios" creada al 
...
bibliotecas = pd.read_csv("C:/Users/franp/OneDrive/Documentos/Pendientes/TP Grupal 1/DataSets_Originales/Bibliotecas_Populares.csv")
...
biblioteca_2.columns = ["id_establecimiento", 
                        "nombre",
                        "id_departamento",
                        "nombre_departamento",
                        "nombre_provincia",
