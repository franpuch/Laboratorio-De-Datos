...
Por favor, en la línea 23 completar con la ruta (path absoluto) donde se encuentre el archivo correspondiente a el Dataset 
...
ruta_csv_3 = os.path.join(carpeta_output, "departamentos.csv")
departamentos.to_csv(ruta_csv_3, index=False, encoding='utf-8') 
