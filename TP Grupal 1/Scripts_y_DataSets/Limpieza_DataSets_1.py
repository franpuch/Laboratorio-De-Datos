...
print("Archivo guardado como 'establecimientos_educativos.csv'")

establecimientos_comunes.to_csv(modelo_path / 'establecimientos_educativos_comunes.csv', index=False)
print("Archivo guardado como 'establecimientos_educativos_comunes.csv'")

departamentos.to_csv(modelo_path / 'departamentos.csv', index=False)
print("Archivo guardado como 'departamentos.csv'")
