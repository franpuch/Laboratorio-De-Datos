...
consultaSQL2 = duckdb.query(""" 
                            SELECT 
                              ...
                              dfi.departamento,
                              nivel_educ_dept.poblacion_total AS poblacion_total   --AÑADÍ AQUÍ
                            FROM dfi 
...
dfi2 = dfi2[["Provincia","departamento","Jardines","Poblacion Jardin","primarias","poblacion_primaria","secundarios","poblacion_secundaria", "poblacion_total"]] # Ordeno las columnas.  --TAMBIÉN AÑADÍ AQUÍ.
