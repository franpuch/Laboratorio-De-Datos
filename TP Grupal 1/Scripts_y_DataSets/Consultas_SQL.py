...
consulta_ii = duckdb.query(""" 
                          SELECT dept.nombre_provincia as provincia, dept.nombre_departamento as departamento, count(BP.año_fundacion) AS cantidad_BP_fundadas_desde_1950 
...
print("Todas las consultas fueron exportadas exitosamente (en formato CSV) a la carpeta 'ConsultasSQL'")
