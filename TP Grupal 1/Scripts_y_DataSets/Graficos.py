...
mails = pd.read_csv(consultas_path / "dfiv.csv")
...
EE_dept.iloc[index,2] = EE_dept.iloc[index,2] / 15
EE_dept.iloc[index,3] = EE_dept.iloc[index,3] / 15
EE_dept.iloc[index,4] = EE_dept.iloc[index,4] / 15
EE_dept.iloc[index,5] = EE_dept.iloc[index,5] / 15 
EE_dept.iloc[index,6] = EE_dept.iloc[index,6] / 15
EE_dept.iloc[index,7] = EE_dept.iloc[index,7] / 15
EE_dept.iloc[index,8] = EE_dept.iloc[index,8] / 15


index2 = cantidad[cantidad['Departamento'] == 'CIUDAD DE BUENOS AIRES'].index

cantidad.iloc[index2,2] = cantidad.iloc[index2,2] / 15 
cantidad.iloc[index2,3] = cantidad.iloc[index2,3] / 15 
cantidad.iloc[index2,4] = cantidad.iloc[index2,4] / 15 
...
EE_dept.plot.scatter(x = 'poblacion_total',
                     y = 'Jardines',
                     ax = ax,
                     color = 'b',
                     legend = False)
...
cantidad.plot.scatter(x = 'Poblacion',
                      y = 'Cant_BP',
                      ax = ax,
                      color = 'b',
                      legend = False)
...
cantidad['BP_per_1000'] = cantidad['Cant_BP'] / cantidad['Poblacion'] * 1000   # Calculo la cantidad de BP y EE cada 1000 habitantes, por departamento (para normalizar).
cantidad['EE_per_1000'] = cantidad['Cant_EE'] / cantidad['Poblacion'] * 1000

plt.figure(figsize = (8, 6))
ax = sns.scatterplot(data = cantidad,
                     x = 'BP_per_1000',
                     y = 'EE_per_1000',
