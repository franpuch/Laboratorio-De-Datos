...
departamento distinto. De los DataSets de 'bibliotecas_populares', 'establecimientos_educativos' y 'nivel_educativo_por_departamento' 
voy a contar la cantidad de elementos distintos que hay en la columna 'id_departamento'. Esas cantidades deberían ser menor/igual 
a la cantidad de departamentos obtenida anterioremente. "Menor/igual" ya que puede suceder que exitan departamentos sin establecimientos 
educativos o bibliotecas populares. Por eso, con que sea menor, me basta.
'''
...
cantidad_deptos_poblacion = nivel_educ_dept["id_departamento"].nunique() 
print("Cantidad de Departamentos distintos en el DataSet de Nivel Educativo por Población: ", cantidad_deptos_poblacion)
