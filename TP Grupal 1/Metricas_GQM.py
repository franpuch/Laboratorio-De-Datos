...
Básicamente, no está estandarizado el formato del campo. Esto se solucionaría si se separase número de característica del resto del número
(por ejemplo).
'''

# print(establecimientos_educativos.dtypes) 
# Antes de meterme en la columna de Teléfonos, verificos con qué tipo de datos están cargados.
